      ...
      <div className="footer-wrap">
        <div className="footer-container">
          <div className="footer-upper-box">
            <div className="footer-corp-box">
              <div className="footer-corp-logo">
                <img src="https://knotehow-image.s3.ap-northeast-2.amazonaws.com/1620708831338.png" alt="footer-logo"/>
              </div>
              <div className="footer-corp-descr">
                <p>노트하우는 대학에서의 새로운 스터디 문화를<br/>
                만들기 위해 노력하고 있습니다.</p>
              </div>
            </div>
            <div className="footer-site-map-box">
              <p className="footer-site-map-header">노트하우</p>
              <p>홈</p>
              <p>채용</p>
              <p>팀 노트하우</p>
            </div>
            <div className="footer-site-map-box">
              <p className="footer-site-map-header">튜터</p>
              <p>지원하기</p>
              <p>튜터 가이드</p>
            </div>
            <div className="footer-site-map-box">
              <p className="footer-site-map-header">고객센터</p>
              <p>1:1 문의하기</p>
            </div>
          </div>
