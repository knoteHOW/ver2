        ...
        <div className="form-wrapper">
          <div className="content">
            ...
            <div className="page-num">
              ...
              <div className="step step-on">2</div>
            </div>
            <div className="title">
              <p>
                Let’s study with k<span className="orange">note</span>HOW!
              </p>
            </div>
                  ...
                  <div className="form">
                    ...
                    >
                        ...
                        <div className="check-box-wrap">
                          <div className="check-box-all">
                            <label htmlFor="all-check">
                              <span className="deco-text" onClick={()=>history.push('/terms/contract')}>서비스 이용약관</span><span>, </span>
                              <span className="deco-text" onClick={()=>history.push('/terms/inform')}>개인정보 수집 및 이용</span><span>, </span>
                              <span>마케팅 활용 동의</span>를 확인했고 동의합니다
                            </label>
                            <div style={{ display: "flex", alignItems: "center" }}>
                                <span onClick={setHide}><img className="drop-img" ref={dropImg} src="https://knotehow-image.s3.ap-northeast-2.amazonaws.com/1620125362937.png" alt=""/></span>
                              <input type="checkbox" name="allCheck" id="all-check" checked={allCheck ? true : false} onChange={changeCheck}/>
                            </div>
                          </div>
                          <div className="check-box-hide" ref={hideBox}>
                            <div className="check-box-area">
                              <label htmlFor="service-check">
                                <span className="deco-text" onClick={()=>history.push('/terms/contract')}>서비스 이용약관</span>에 동의합니다. (필수)
                              </label>
                            ...
                            <div className="check-box-area">
                              <label htmlFor="inform-check">
                                <span className="deco-text" onClick={()=>history.push('/terms/inform')}>개인정보 수집 및 이용</span>에 동의합니다. (필수)
                              </label>
                      ...
                      <Form.Item>
                        ...
                        (
                          <div className="off-btn">동의하고 가입완료!</div>
                        )}
