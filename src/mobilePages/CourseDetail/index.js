...
import CoursePass from './CoursePass';
...
const CourseDetail = ()=>{
  ...
  const getPass = async () => {
    try {
      const result = await axios.get('/passes')
      if(result.status === 200) {
        result.data.passes.length>0 && result.data.passes.map(pass => {
          if(pass.course_page.courseId == courseId) {
            setIsPass(true);
          }
        })
      } else {
      ...
      { !isPass ? 
        <div>
          <div className="m-course-container">
            ...
            <div className="m-course-ad"></div>

            <div className="m-course-body-top">
              <div className="m-course-body-top-text1">
                <p>너무 어렵다구요?</p>
                <p>개념노트로 공부해보세요!</p>
              </div>
              <div className="m-course-body-top-image"></div>
              <div className="m-course-body-top-middle">
                ...
                <div className="m-course-body-top-note">
                  <div className="m-course-body-top-button"><p>노트보러가기</p></div>
                </div>
                <div className="m-course-body-top-text2">언택트 시대에 혼자 공부하기 너무 어렵지 않나요? 언택트 시대에 혼자 공부하기 너무 어렵지 않나요?</div>
              </div>
            </div>
            ...
            <div className="m-course-body-qna">
              <div className="m-course-body-qna-more">
                <p>더보기 ></p>
              </div>
              <div className="m-course-body-qna-text1">
                <p>모르는것들은</p>
                <p>튜터에게 질문해보세요!</p>
              </div>
              ...
              <div className="m-course-body-qnalist ">
                {
                  questions && questions.map(question => (
                    <div className="qna-wrap">
                      <Question question={question} isPass={false}/>
                    </div>
                  ))
                }
              </div>
            ...
            <div className="m-course-reco">          
              <div className="m-course-reco-text"> 
                <div className="m-course-reco-text-top">
                  <p>{course.univ}</p>
                  <p>학생들이</p>
                </div> 
                <p>많이 보고 있는 강의</p>
              ...
              <div className = "m-course-reco-scroll">
                <div className = "m-course-reco-course">
                  {coursel.map(item=>(
            ...
            <DetailFooter isPass={false} isContain={isContain} cnt={bookmarkCount} id={coursePageId}/>
          </div>
